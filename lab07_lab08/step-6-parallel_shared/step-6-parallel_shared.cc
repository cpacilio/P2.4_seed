...
/*TODO: Define the forcing function. */
...
void Step6<dim>::setup_system ()
{
  ...
  system_matrix.reinit (/*TODO*/,
                        /*TODO*/,
                        sparsity_pattern,
                        mpi_communicator);
  solution.reinit (/*TODO*/, mpi_communicator);
  system_rhs.reinit (/*TODO*/, mpi_communicator);
}
...
void Step6<dim>::assemble_system ()
{
  ...
  system_matrix.compress(/*TODO*/);
  system_rhs.compress(/*TODO*/);
}
...
void Step6<dim>::solve ()
{
  ...
  SolverCG</*TODO*/>  solver (solver_control);
...
void Step6<dim>::refine_grid ()
{
  ...
  /* TODO: Initialise this vector such that it contains the values
   * of the solution for both locally owned and locally relevant
   * degrees of freedom.
   */
...
void Step6<dim>::output_results (const unsigned int cycle) const
{
  ...
  data_out.add_data_vector (/*TODO*/, "solution");
...
{
  /*TODO: Correctly initialise the MPI environment*/
